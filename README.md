...
- **Control Documental filtra por varias especialidades y varios tipos a la
  ...
  informes, sin saltar entre listas. Los dos filtros se cruzan. El resumen
  sigue la selección: la dona de progreso y las barras por especialidad
  muestran solo lo elegido, y el semáforo de estados cuenta sobre eso mismo.
  "Todas"/"Todos" vuelve al proyecto completo.
