...
import {
  ...
  Building2, Zap, Cog, Mountain, Plus, Search, X, Printer,
  ...
  Folder, ChevronDown, ChevronRight, Video,
  Bold, Italic, Underline, List, PartyPopper, MessageSquare, PieChart, AlertTriangle, Menu, UserPlus, Boxes,
  CircleDot, Lightbulb, Home, Wrench, KeyRound, Copy, GitBranch, Bell,
} from 'lucide-react';
...
import { EQUIPO_TIPOS, EQUIPO_SEED, EquipoIcono } from './secciones/equiposDatos.jsx';
...
import {
  ...
  TRASLAPO_TABLE, aplicarParametrosIngenieria,
} from './secciones/cimentacionesDatos.js';
import { ACTUALIZACION_CATEGORIAS_SEED } from './secciones/actualizacionesDatos.js';
import {
  ROLES, usaResumenPersonal, esRolMultiple, equipoComoArray, equipoNombres, equipoTexto,
  ALL_ROLE_DEFS, EQUIPO_CATEGORIAS, rolesLabel, isDeveloper, isLeader, isDesignLeader,
  isQA, canAssignRole, isAssignedToProject, esAprobadorDe,
